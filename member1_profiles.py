...
Handles: Registration, Login, Profiles, Achievements
"""
...
def register_student():
    ...
    with open("data/students.txt", "a") as f:
        # Starting values: 100 coins, level 1, Noob title, 0 reputation, no NFTs, no achievements
...
def update_student_coins(student_id, amount):
    """Add or remove coins from student (called by other modules)"""
    students = get_all_students()
    ...
    for student in students:
        if student['id'] == student_id:
            ...
            # Check for level up (every 100 coins = 1 level)
...
def view_achievements_list():
    ...
    print("\n" + "="*60)
    print("🏅 ALL ACHIEVEMENTS".center(60))
    print("="*60)
...
# ============= TESTING CODE (Remove when integrating) =============
...
if __name__ == "__main__":
    ...
    print("Testing Member 1: Profile System")
    print("1. Register")
    print("2. Login")
    choice = input("Choose: ")
